...
#define GPS_INTERVAL_MS    86400000               //24 h         //GPS强制更新间隔.
#define UPLOAD_DATA_INTERVAL_MS   600000					        //15 min       //上传间隔 test 15min (900000 ms)
#define MAX_WAKE_MS        360000//660000                //单次最大工作时长 test 2.5min (150000 ms)
#define MAX_GPS_MS         300000//600000                //GPS单次更新时长 test 1.5min (90000 ms)
#define MAX_PM25_MS        90000                          //PM2d5稳定时间 test 1.5min (90000 ms)
//#define MAX_GPS_MS         30000//600000                //GPS单次更新时长 test 1.5min (90000 ms)
//#define MAX_PM25_MS        10000                          //PM2d5稳定时间 test 1.5min (90000 ms)
#define HTTP_REQUEST_MS    45000                          //得不到200时，强制发送数据的间隔.  

#define DIVED_DAY					 8

//#define GPS_INTERVAL_MS    86400000               //24 h         //GPS强制更新间隔
//#define UPLOAD_DATA_INTERVAL_MS   1800000//900000         //15 min       //上传间隔 test 30min
//#define MAX_WAKE_MS        210000//660000         //11 min       //单次最大工作时长 test 3.5min
//#define MAX_GPS_MS         150000//600000          //10 min       //GPS单次更新时长 test 2.5min
//#define MAX_PM25_MS        90000                  //2 min        //PM2d5稳定时间 test 1.5min (90000 ms)
